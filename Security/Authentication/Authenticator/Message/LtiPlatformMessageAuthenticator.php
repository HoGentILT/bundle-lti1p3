...
class LtiPlatformMessageAuthenticator extends AbstractLtiAuthenticator
{
    ...
    public function __construct(PlatformLaunchValidatorInterface $validator, HttpMessageFactoryInterface $factory, array $types = [])
    {
    ...
    public function authenticate(Request $request): Passport
    {
        try
        {
            $validationResult = $this->validator->validateToolOriginatingLaunch($this->factory->createRequest($request));
    ...
    public function createToken(Passport $passport, string $firewallName): TokenInterface
    {
        ...
        return new LtiPlatformMessageSecurityToken($passport->getLtiBadge()->getResult());
    }
